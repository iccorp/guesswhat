...
To optimize the guesswhat application for production, run:
...
[Doing API-First development]: http://www.jhipster.tech/documentation-archive/v4.12.0/doing-api-first-development/
