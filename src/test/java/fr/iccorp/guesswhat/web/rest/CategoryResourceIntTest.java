...
import fr.iccorp.guesswhat.domain.Category;
import fr.iccorp.guesswhat.repository.CategoryRepository;
import fr.iccorp.guesswhat.service.CategoryService;
import fr.iccorp.guesswhat.service.dto.CategoryDTO;
import fr.iccorp.guesswhat.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getValue()).isEqualTo(DEFAULT_VALUE);
    }
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getValue()).isEqualTo(UPDATED_VALUE);
    }
