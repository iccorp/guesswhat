...
import fr.iccorp.guesswhat.config.audit.AuditEventConverter;
import fr.iccorp.guesswhat.domain.PersistentAuditEvent;
...
import static fr.iccorp.guesswhat.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
